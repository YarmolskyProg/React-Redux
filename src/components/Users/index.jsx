  ...
  return (
    <>
      <div className="search">
        ...
        <input value={search} onChange={e => handlerChange(e)} type="text" placeholder="Найти пользователя..." />
      </div>
      {isLoading ? (
      ...
      {invitelist.length > 0
        &&
        <button onClick={() => setresult(false)} className="send-invite-btn">Отправить приглашение</button>
      }
    </>
  );
};
