...
export const User = ({ id, first_name, last_name, email, avatar, onInvite, invitelist }) => (
  <li>
    <div>
    ...
    <img onClick={() => onInvite(id)} className="action" src={`/assets/${invitelist.includes(id) ? 'minus.svg' : 'plus.svg'}`} alt="Action" />
  </li>
);
